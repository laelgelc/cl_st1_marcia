# `all_seasons_check.py` programme specification

The programme performs the following tasks:

1. Reads each text file in `Directory 1` (e.g. `Amy_Season_3.txt`)
...
- Directory 1: `01_all_seasons_utf_8`
- Directory 2: `01_all_seasons_utf_8_straight`

## Output data

- Report file: `02_all_seasons_check_report.txt`
